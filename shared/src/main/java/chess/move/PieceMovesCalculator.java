 ...
 */
    ...
    /**
     * Loops through each position along the line of the given direction vector from the initial position and adds valid
     * moves to the move set.
     * <p>
     ...
     */
    protected static
    void addAttackRange(int[] vec, HashSet<ChessMove> possibleMoves, ChessBoard board,
     ...
     */
    public static
    PieceMovesCalculator createInstance(ChessPiece.PieceType type) {
        return switch (type) {
